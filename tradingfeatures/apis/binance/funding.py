...
class binanceFunding(binanceBase):
    ...
    def get_recent(self, df):
        ...
        df_temp = pd.DataFrame(
            [[result["nextFundingTime"], result["lastFundingRate"]]],
            columns=["timestamp", "fundingRate_binance"],
        )
    ...
    def get_hist(self, columns=None, *args, **kwargs):
        ...
        return apiBase.get_hist(self, columns=columns, interval="8h", *args, **kwargs)
